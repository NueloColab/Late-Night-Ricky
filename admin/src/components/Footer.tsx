export default function Footer() {
  return (
    <footer className="bg-[#0f0518] px-6 py-12 text-center">
      <div className="flex justify-center gap-6 mb-10">
        {['facebook','instagram','twitter'].map((s) => (
          <a key={s} href="#" className="w-12 h-12 rounded-full border border-[rgba(163,181,196,0.25)] flex items-center justify-center text-[#8b7ab4] hover:border-[#a890c0] hover:text-white hover:-translate-y-1 transition">
