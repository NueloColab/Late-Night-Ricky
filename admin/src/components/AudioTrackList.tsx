        ...
        return (
          ...
          >
            ...
            <div className="flex flex-col min-w-0">
              {/* Title */}
              <span className="text-[17px] md:text-[20px] font-bold text-[#2a1a0a] leading-tight pt-1 tracking-tight" style={{ fontFamily: "var(--font-righteous), 'Righteous', var(--font-montserrat), 'Montserrat', sans-serif" }}>
                {track.title}
              </span>
