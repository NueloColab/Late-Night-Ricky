    ...
    <section id="contact-form" className="textured-bg relative z-10 pt-16 md:pt-0">
      <div className="grid md:grid-cols-2 gap-0 min-h-[calc(100vh-70px)] items-stretch">
        ...
        <div className="relative overflow-hidden min-h-[300px] md:min-h-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-transparent via-transparent to-[#1a0a2e]/90 md:bg-gradient-to-r md:from-transparent md:via-[#1a0a2e]/30 md:to-[#1a0a2e]/95" />
        </div>
        ...
        <div className="relative z-10 py-20 px-8 md:px-16 max-w-[600px] mx-auto w-full">
          ...
          {submitted ? (
            <div className="text-center py-10">
              <p className="text-lg font-semibold text-[#d490a8] mb-2">✓ Message sent successfully</p>
            ...
            <>
              <form onSubmit={handleSubmit} hidden={activeTab !== 'booking'} data-tab="booking">
                {[
                  ...
                  <div key={field.name} className="mb-5">
                    <label className="block text-xs font-semibold uppercase tracking-[1.5px] text-[#8b7ab4] mb-2">{field.label}</label>
                ...
                <button type="submit" disabled={submitting} className="w-full py-4 bg-white text-[#111] text-sm font-semibold uppercase tracking-[2px] hover:bg-[#8b7ab4] transition disabled:opacity-50">
              ...
              <form onSubmit={handleSubmit} hidden={activeTab !== 'private'} data-tab="private">
                ...
                <div className="mb-5">
                  <label className="block text-xs font-semibold uppercase tracking-[1.5px] text-[#8b7ab4] mb-2">Message *</label>
