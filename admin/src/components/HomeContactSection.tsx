    ...
    <section id="contact-form" className="textured-bg relative z-10 pt-16 md:pt-0">
      <div className="grid md:grid-cols-2 gap-0 min-h-[calc(100vh-70px)] items-stretch">
        ...
        <div className="relative overflow-hidden min-h-[300px] md:min-h-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-transparent via-transparent to-[#0d1f2d]/90 md:bg-gradient-to-r md:from-transparent md:via-[#0d1f2d]/30 md:to-[#0d1f2d]/95" />
        </div>
          ...
          {submitted ? (
            ...
            <>
              <form onSubmit={handleSubmit} hidden={activeTab !== 'booking'} data-tab="booking">
                {[
                  ...
                  <div key={field.name} className="mb-5">
                    <label className="block text-xs font-semibold uppercase tracking-[1.5px] text-[#A3B5C4] mb-2">{field.label}</label>
                ...
                <button type="submit" disabled={submitting} className="w-full py-4 bg-white text-[#111] text-sm font-semibold uppercase tracking-[2px] hover:bg-[#A3B5C4] transition disabled:opacity-50">
              ...
              <form onSubmit={handleSubmit} hidden={activeTab !== 'private'} data-tab="private">
                ...
                <div className="mb-5">
                  <label className="block text-xs font-semibold uppercase tracking-[1.5px] text-[#A3B5C4] mb-2">Message *</label>
