        ...
        <div className="w-full max-w-[600px]">
          {!expanded ? (
            <div className="text-center md:text-left">
              ...
              <h2 className="text-[clamp(32px,4vw,56px)] font-black uppercase tracking-[0.02em] leading-[0.95] text-[#e8d4b8] mb-6" style={{ fontFamily: "'Cocogoose', var(--font-montserrat), 'Montserrat', sans-serif" }}>CONTACT</h2>
