    ...
    <>
      ...
      <section id="moments" className="relative py-20 md:py-28 px-6 md:px-14 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto">
          <h2 className="text-[clamp(32px,5vw,56px)] font-black uppercase tracking-[-1px] leading-[1.1] text-[#5a3a1a] text-center mb-14 md:mb-20 reveal-fade" style={{ fontFamily: "'Oswald', sans-serif" }}>
            Late Night Moments
          </h2>
