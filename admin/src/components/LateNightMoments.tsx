    ...
    <>
      ...
      <section id="moments" className="relative py-20 md:py-28 px-6 md:px-14 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto">
          <h2 className="flex items-center justify-center gap-2 md:gap-3 text-[clamp(28px,4vw,52px)] font-black tracking-[0.02em] leading-[1.1] text-[#5a3a1a] text-center mb-2 whitespace-nowrap reveal" style={{ fontFamily: "'Cocogoose', var(--font-montserrat), 'Montserrat', sans-serif", textShadow: '0 2px 8px rgba(90,58,26,0.15)', WebkitTextStroke: '1.5px #5a3a1a', paintOrder: 'stroke fill' }}>
            {headingText}
          </h2>
          ...
          >
            ...
            {activeMoment && (activeMoment.images?.length > 0 || activeMoment.video) ? (
              ...
              <div className="relative z-10 p-5 md:p-8">
                <h2 className="text-[clamp(24px,3.5vw,40px)] font-black uppercase tracking-[0.02em] leading-[1] text-[#e8d4b8] mb-2 pr-12" style={{ fontFamily: "'Cocogoose', var(--font-montserrat), 'Montserrat', sans-serif" }}>
                  {activeMoment.title}
                </h2>
              ...
              <div className="relative z-10 p-5 md:p-8 flex flex-col items-center justify-center min-h-[200px]">
                <h2 className="text-[clamp(24px,3.5vw,40px)] font-black uppercase tracking-[0.02em] leading-[1] text-[#e8d4b8] mb-3 pr-12" style={{ fontFamily: "'Cocogoose', var(--font-montserrat), 'Montserrat', sans-serif" }}>
