    ...
    <>
      ...
      <section id="moments" className="relative py-20 md:py-28 px-6 md:px-14 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto">
          <h2 className="flex items-center justify-center gap-2 md:gap-3 text-[clamp(36px,5.5vw,64px)] font-black uppercase tracking-[0.02em] leading-[1.1] text-[#5a3a1a] text-center mb-2 whitespace-nowrap reveal" style={{ fontFamily: "var(--font-paytone), 'Paytone One', var(--font-montserrat), 'Montserrat', sans-serif", textShadow: '0 2px 8px rgba(90,58,26,0.15)' }}>
            {headingText}
          </h2>
