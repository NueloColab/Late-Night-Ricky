            ...
            <div>
              ...
              <div className="flex gap-4 flex-wrap mb-10">
                <a href="https://open.spotify.com/artist/4AK6F2O4Il0oZ8pSpuOOnl" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2.5 px-7 py-3.5 border-2 border-[#111] rounded-full text-[#111] text-[13px] font-semibold uppercase tracking-[1.5px] hover:bg-[#111] hover:text-white transition">
                  <svg width="20" height="20" viewBox="0 0 168 168" fill="currentColor"><path d="M84 0C37.6 0 0 37.6 0 84s37.6 84 84 84 84-37.6 84-84S130.4 0 84 0zm38.5 121.2c-1.5 2.5-4.7 3.2-7.1 1.7-19.5-11.9-44.1-14.6-73-8.1-2.8.6-5.6-1.1-6.2-3.9-.6-2.8 1.1-5.6 3.9-6.2 31.6-7.2 58.4-4.2 80.2 8.9 2.4 1.4 3.1 4.5 1.7 7zm10.3-22.9c-1.9 3-5.9 4-8.9 2.1-22.3-13.7-56.3-17.7-82.7-9.7-3.4 1-7.1-.9-8.1-4.3-1-3.4.9-7.1 4.3-8.1 30.2-9.2 67.7-4.7 92.8 11.1 3.1 1.9 4.1 5.9 2.2 8.9zm.9-23.8c-26.8-15.9-70.9-17.3-96.4-9.6-4.1 1.2-8.4-1.1-9.6-5.2-1.2-4.1 1.1-8.4 5.2-9.6 29.2-8.8 77.6-7.2 107.7 11.1 3.7 2.2 4.9 7 2.7 10.7-2.2 3.6-7 4.9-10.6 2.6z" fill="#1DB954"/></svg>
                  Spotify
                </a>
