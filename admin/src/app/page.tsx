  ...
  return (
    <>
      ...
      <section className="relative min-h-[100dvh] px-8 md:px-14 pb-14 pt-20">
        ...
        <div className="absolute z-10 flex flex-col items-center md:items-start justify-center md:justify-start top-[22%] md:top-auto md:mt-[30vh] left-1/2 -translate-x-1/2 md:left-[15%] md:translate-x-0 md:w-auto md:max-w-[45%]">
