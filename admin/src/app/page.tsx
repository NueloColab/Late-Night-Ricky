      ...
      <section className="garrix-venues-section">
        ...
        <div className="garrix-venues-track">
          <div className="garrix-venues-row garrix-venues-row-forward">
            <span className="garrix-venues-highlight">LIV Miami</span><span className="garrix-venues-dot">·</span>
            <span>HAKKASAN Las Vegas</span><span className="garrix-venues-dot">·</span>
            <span className="garrix-venues-highlight">MINISTRY OF SOUND London</span><span className="garrix-venues-dot">·</span>
            ...
            <span className="garrix-venues-highlight">1 OAK Dubai</span><span className="garrix-venues-dot">·</span>
            ...
            <span className="garrix-venues-highlight">O2 ARENA London</span><span className="garrix-venues-dot">·</span>
          ...
          <div className="garrix-venues-row garrix-venues-row-reverse">
            ...
            <span className="garrix-venues-highlight">TAPE London</span><span className="garrix-venues-dot">·</span>
            <span>MOVIDA Dubai</span><span className="garrix-venues-dot">·</span>
            <span className="garrix-venues-highlight">1 OAK New York</span><span className="garrix-venues-dot">·</span>
            ...
            <span className="garrix-venues-highlight">DELILAH Los Angeles</span><span className="garrix-venues-dot">·</span>
            ...
            <span className="garrix-venues-highlight">TAO Las Vegas</span><span className="garrix-venues-dot">·</span>
            ...
            <span className="garrix-venues-highlight">USHUAÏA Ibiza</span><span className="garrix-venues-dot">·</span>
          ...
          <div className="garrix-venues-row garrix-venues-row-forward">
            ...
            <span className="garrix-venues-highlight">HIGHLIGHT ROOM Los Angeles</span><span className="garrix-venues-dot">·</span>
            ...
            <span className="garrix-venues-highlight">BAOLI Cannes</span><span className="garrix-venues-dot">·</span>
            ...
            <span className="garrix-venues-highlight">WIRELESS FESTIVAL UK</span><span className="garrix-venues-dot">·</span>
