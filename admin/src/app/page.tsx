            ...
            <div>
              ...
              <div className="flex gap-4 flex-wrap mb-10">
                <a href="https://open.spotify.com/artist/4AK6F2O4Il0oZ8pSpuOOnl" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2.5 px-7 py-3.5 border-2 border-[#111] rounded-full text-[#111] text-[13px] font-semibold uppercase tracking-[1.5px] hover:bg-[#111] hover:text-white transition">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="0"><path d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.6 0 12 0zm5.5 17.3c-.2.3-.5.4-.8.2-2.2-1.3-5-1.6-8.3-.9-.3.1-.6-.1-.7-.4-.1-.3.1-.6.4-.7 3.6-.8 6.7-.5 9.2.9.3.2.4.5.2.9zm1.5-3.3c-.2.4-.7.5-1 .3-2.5-1.5-6.3-2-9.3-1.1-.4.1-.8-.1-.9-.5-.1-.4.1-.8.5-.9 3.4-1 7.6-.5 10.5 1.2.4.2.5.7.2 1zm.1-3.5C15.8 8.4 9.3 8.2 5.4 9.4c-.5.1-1-.2-1.1-.7-.1-.5.2-1 .7-1.1 4.5-1.4 11.5-1.1 15.9 1.5.4.3.6.9.3 1.3-.3.4-.8.5-1.2.2z" fill="currentColor"/></svg>
                  Spotify
                </a>
                <a href="https://music.apple.com/gb/artist/late-night-ricky/1234567890" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2.5 px-7 py-3.5 border-2 border-[#111] rounded-full text-[#111] text-[13px] font-semibold uppercase tracking-[1.5px] hover:bg-[#111] hover:text-white transition">
                  <svg width="18" height="20" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="0"><path d="M18.7 17.4c-.7 1.2-1.5 2.3-2.2 2.3-.7 0-1-.5-1.8-.5s-1.2.5-1.8.5c-.8 0-1.5-1.1-2.2-2.3-1.5-2.5-1.7-5.4-.7-5.9.5-.2 1.3.1 1.9.5.6.4 1.2.6 1.6.6s.7-.2 1.3-.6c.8-.5 1.6-.7 2.1-.5 1.2.4 1.7 2.5.9 4.9zm-3.2-8.4c.7-.8 1.2-2 .9-3.1-.9 0-2 .6-2.6 1.4-.7.8-1.2 2-.9 3.1 1 0 2-.6 2.6-1.4z" fill="currentColor"/></svg>
                  Apple Music
                </a>
                <a href="https://www.youtube.com/@LateNightRicky" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2.5 px-7 py-3.5 border-2 border-[#111] rounded-full text-[#111] text-[13px] font-semibold uppercase tracking-[1.5px] hover:bg-[#111] hover:text-white transition">
                  <svg width="20" height="14" viewBox="0 0 24 17" fill="currentColor" stroke="currentColor" strokeWidth="0"><path d="M23.5 2.6c-.3-1.1-1.1-1.9-2.2-2.2C19.5 0 12 0 12 0S4.5 0 2.7.4C1.6.7.8 1.5.5 2.6 0 4.4 0 8.5 0 8.5s0 4.1.5 5.9c.3 1.1 1.1 1.9 2.2 2.2 1.8.4 9.3.4 9.3.4s7.5 0 9.3-.4c1.1-.3 1.9-1.1 2.2-2.2.5-1.8.5-5.9.5-5.9s0-4.1-.5-5.9zM9.6 12.1V4.9l6.2 3.6-6.2 3.6z" fill="currentColor"/></svg>
                  YouTube
                </a>
              </div>
