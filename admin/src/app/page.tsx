          ...
          <div className="garrix-footer-follow">
            ...
            <div className="garrix-footer-socials">
              ...
              <a href="https://soundcloud.com/latenightricky" target="_blank" rel="noopener noreferrer" className="garrix-footer-social-square" aria-label="SoundCloud">
                <svg viewBox="0 0 24 24" fill="currentColor"><path d="M11.56 8.87V17h8.76c1.85 0 3.35-1.5 3.35-3.35 0-1.85-1.5-3.35-3.35-3.35-.25 0-.5.03-.73.08C19.13 7.94 16.84 6 14.07 6c-.94 0-1.83.21-2.64.58l.13 2.29zM8.76 9.79V17h1.67V9.12c-.4.18-.78.4-1.13.67zm-2.79 1.92V17h1.67v-6.43c-.44.34-.84.73-1.19 1.14zM3.18 13.31V17h1.67v-3.69c-.3.3-.55.64-.77 1zm-2.23 1.14V17h1.67v-2.55c-.35.3-.67.64-.96 1z"/></svg>
              </a>
