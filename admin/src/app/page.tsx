            ...
            <div>
              ...
              <div className="flex gap-4 flex-wrap mb-10">
                ...
                <a href="https://music.apple.com/gb/artist/late-night-ricky/1759491226" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-7 py-3 border-2 border-[#111] rounded-full text-[#111] text-[13px] font-semibold uppercase tracking-[1.5px] hover:bg-[#111] hover:text-white transition">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M15.534 10.77c0 .007-.002.014-.003.02-.064.02-1.49.574-1.49 1.773 0 1.38 1.215 1.87 1.252 1.882.007.003.01.007.01.011.003.02-.192.66-.64 1.32-.398.57-.814 1.147-1.447 1.147-.506 0-.793-.368-1.523-.368-.742 0-1.008.38-1.54.38-.598 0-.986-.533-1.446-1.194-.62-.893-1.08-2.09-1.08-3.316 0-1.814 1.18-2.77 2.342-2.77.616 0 1.13.406 1.516.406.368 0 .942-.43 1.643-.43.267 0 1.218.02 1.846.932-.053.006.057-.003.057-.003zM13.353 8.923c.29-.35.493-.835.493-1.32 0-.066-.005-.134-.016-.192-.466.017-1.02.313-1.354.698-.27.315-.52.807-.52 1.3 0 .077.005.153.018.18.03.005.077.01.122.01.42 0 .944-.287 1.257-.676z" fill="currentColor"/></svg>
                  Apple
                </a>
