    ...
    <>
      ...
      <section id="artists" className="relative py-10 md:py-28 px-6 md:px-14 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto">
          ...
          <h2 className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-3 text-[clamp(18px,3vw,36px)] font-black uppercase tracking-[-1px] leading-[0.95] text-[#e8d4b8] text-center mb-6 md:mb-8 reveal" style={{ fontFamily: "var(--font-righteous), 'Righteous', var(--font-montserrat), 'Montserrat', sans-serif" }}>
            <div>
              <img
      ...
      <section id="venues" className="relative py-20 md:py-28 px-6 md:px-14 overflow-hidden">
        <div className="relative z-10 max-w-[1400px] mx-auto">
          <div className="relative text-center reveal-fade border-t border-[#c4b498]/20 pt-12 pb-16 md:pb-10 rounded-xl overflow-hidden">
            ...
            <h2 className="relative z-10 text-[clamp(28px,3.5vw,48px)] font-black uppercase tracking-[-1px] leading-[0.95] text-[#e8d4b8] text-center mb-12" style={{ fontFamily: "'Oswald', sans-serif" }}>
              {venuesData.heading}
            </h2>
