  ...
  return (
    <>
      ...
      <section className="relative min-h-[100dvh] px-8 md:px-14 pb-14 pt-20">
        ...
        />
        {/* Logo + subtitle — desktop: left side, ~40% width, at waist level; mobile: centered */}
        <div className="absolute z-10 flex flex-col items-center md:items-start justify-center md:justify-start h-full md:h-auto md:mt-[30vh] w-full md:w-auto md:max-w-[45%] md:left-[5%] px-4 md:px-0">
      ...
      <section id="venues" className="relative py-20 md:py-28 px-6 md:px-14 overflow-hidden">
        <div className="relative z-10 max-w-[1400px] mx-auto">
          <div className="relative text-center reveal-fade border-t border-[#c4b498]/20 pt-12 pb-16 md:pb-10 rounded-xl overflow-hidden">
            ...
            <div className="relative z-10 grid grid-cols-2 md:grid-cols-2 gap-x-2 md:gap-x-6 gap-y-0.5 md:gap-y-1 max-w-[800px] mx-auto pl-2 md:pl-12 justify-items-start">
              <div className="space-y-0.5 md:space-y-1">
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">LIV (Miami)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">WALL (Miami)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">TAPE (London)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">HAKKASAN (Las Vegas)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">MOVIDA (Dubai)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">JIMMY&apos;Z (Monte Carlo)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">MINISTRY OF SOUND (London)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">1 OAK (New York)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">BYBLOS (Milan)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">PACHA (Ibiza)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">ARMANI (Dubai)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">MANDALAY BAY (Las Vegas)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">TEMPLE (San Francisco)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">POPPY (Los Angeles)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">CIRQUE LE SOIR (London)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">HIGHLIGHT ROOM (Los Angeles)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">TEDDY&apos;S @ ROOSEVELT (Los Angeles)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">DELILAH (Los Angeles)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">GIBSON (Frankfurt)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">LIO (Ibiza)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">STUDIO PARIS (Chicago)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">PREMIER @ BORGATE (Atlantic City)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">PARQ (San Diego)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">BOOTSY BELLOWS (Los Angeles)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">WARWICK (Los Angeles)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">LAVO (New York)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">TAO (New York)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">UP & DOWN (New York)</p>
              </div>
              <div className="space-y-0.5 md:space-y-1">
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">LIBERTINE (London)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">SCANDAL (London)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">TOY ROOM (Dubai)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">1 OAK (Dubai)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">TAO (Las Vegas)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">BAOLI (Cannes)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">SHOKO (Barcelona)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">LASTA (Serbia)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">REX ROOMS (London)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">HARRIET&apos;S (Los Angeles)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">VIP ROOM (St. Tropez)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">BON BONNIERE (Mykonos)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">DRAMA (London)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">DEAR DARLING (London)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">TRAMP (London)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">SPIRITO (Brussels)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">CUCKOO CLUB (London)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">RAFFLES (London)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">SUBOIS (Montreal)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">P1 (Munich)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">ZELO&apos;S (Monte Carlo)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">BOOTSY BELLOWS (Los Angeles)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">WARWICK (Los Angeles)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">LAVO (New York)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">TAO (New York)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">UP & DOWN (New York)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">WIRELESS FESTIVAL (UK)</p>
                <p className="text-[10px] md:text-[13px] text-[#d4c4a8]/80">READING & LEEDS FESTIVAL (UK)</p>
              </div>
            </div>
          </div>
        </div>
