...
export default async function HomePage() {
  ...
  const heroImage = '/assets/hero-portrait-2026-07-01.png';
  ...
  try {
    ...
    if (dbSections.length > 0) {
      ...
      if (heroSection?.content) {
        ...
        // CMS hero image override disabled — using new generated portrait
  ...
  return (
    <>
      ...
      <section className="relative min-h-[100dvh] flex flex-col justify-center px-8 md:px-14 pb-14 pt-20">
        ...
        />
        <img src={heroLogo} alt="Late Night Ricky" className="relative z-10 w-[52%] max-w-[700px] min-w-[280px] mx-auto mt-auto mb-24 drop-shadow-[0_4px_30px_rgba(0,0,0,0.4)]" />
