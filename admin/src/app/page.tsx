  ...
  return (
    <>
      ...
      <section className="relative min-h-[100dvh] flex flex-col items-center justify-center px-8 md:px-14 pb-14 pt-20">
        ...
        <img src={heroLogo} alt="Late Night Ricky" className="relative z-10 w-[52%] max-w-[700px] min-w-[280px] mx-auto mb-14 brightness-0 invert opacity-80 drop-shadow-[0_4px_30px_rgba(168,213,240,0.4)]" />
