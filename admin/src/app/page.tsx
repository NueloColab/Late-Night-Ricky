    ...
    <>
      ...
      <section id="about" className="relative min-h-[100dvh] overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-14 py-20 min-h-[100dvh] flex flex-col justify-center">
          ...
          <div className="mb-10 md:mb-14 reveal text-center">
            <p className="text-[24px] md:text-[clamp(32px,5vw,56px)] font-black uppercase tracking-[0.02em] leading-[1.1] text-[#e8d4b8] max-w-[1000px] mx-auto" style={{ fontFamily: "var(--font-paytone), 'Paytone One', var(--font-montserrat), 'Montserrat', sans-serif", textShadow: '0 2px 20px rgba(0,0,0,0.4)' }}>
              {aboutQuote}
            </p>
      ...
      <section id="artists" className="relative py-10 md:py-28 px-6 md:px-14 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto">
          ...
          <h2 className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-3 text-[clamp(18px,3vw,36px)] font-black uppercase tracking-[0.02em] leading-[0.95] text-[#e8d4b8] text-center mb-6 md:mb-8 reveal" style={{ fontFamily: "var(--font-paytone), 'Paytone One', var(--font-montserrat), 'Montserrat', sans-serif" }}>
            <div>
              <img
            ...
            >
              ...
              {[...performersData.row1Images, ...performersData.row1Images, ...performersData.row1Images].map((img: string, i: number) => (
                <div key={i} className="flex-shrink-0 w-[260px] md:w-[340px] aspect-square overflow-hidden" style={{ backfaceVisibility: 'hidden' }}>
                  <img src={img} alt={`Artist ${(i % performersData.row1Images.length) + 1}`} className="w-full h-full object-cover" loading="eager" />
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="relative overflow-hidden mb-16">
            ...
            >
              {[...performersData.row2Images, ...performersData.row2Images, ...performersData.row2Images].map((img: string, i: number) => (
                <div key={i} className="flex-shrink-0 w-[260px] md:w-[340px] aspect-square overflow-hidden" style={{ backfaceVisibility: 'hidden' }}>
                  <img src={img} alt={`Artist ${(i % performersData.row2Images.length) + 1}`} className="w-full h-full object-cover" loading="eager" />
                </div>
              ))}
            </div>
          </div>
      ...
      <section id="venues" className="relative py-20 md:py-28 px-6 md:px-14 overflow-hidden">
        <div className="relative z-10 max-w-[1400px] mx-auto">
          <div className="relative text-center reveal-fade border-t border-[#c4b498]/20 pt-12 pb-16 md:pb-10 rounded-xl overflow-hidden">
            ...
            <h2 className="relative z-10 text-[clamp(28px,3.5vw,48px)] font-black uppercase tracking-[0.02em] leading-[0.95] text-[#e8d4b8] text-center mb-12" style={{ fontFamily: "var(--font-paytone), 'Paytone One', var(--font-montserrat), 'Montserrat', sans-serif" }}>
              {venuesData.heading}
            </h2>
      ...
      <section id="brands" className="relative min-h-[80dvh] md:min-h-[100dvh] overflow-hidden" style={{ contain: 'paint', transform: 'translate3d(0,0,0)' }}>
        ...
        <div className="absolute inset-0 opacity-[0.08]" style={{ backgroundImage: "url('/assets/noise-256.png')", backgroundSize: '256px 256px' }} />
