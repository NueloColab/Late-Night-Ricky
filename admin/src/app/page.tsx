            ...
            <div>
              ...
              <div className="flex gap-4 flex-wrap mb-10">
                ...
                <a href="https://music.apple.com/gb/artist/late-night-ricky/1759491226" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-7 py-3 border-2 border-[#111] rounded-full text-[#111] text-[13px] font-semibold uppercase tracking-[1.5px] hover:bg-[#111] hover:text-white transition">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M12.152 6.896c-.948 0-2.415-1.078-3.96-1.04-2.04.027-3.91 1.183-4.961 3.014-.237.432-.399.9-.467 1.383.008.066.013.133.013.2 0 1.379 1.091 2.513 2.48 2.62 1.445.112 2.432-.922 3.673-.922 1.267 0 2.117.879 3.673.922 1.379.107 2.48-1.24 2.48-2.62 0-.067-.005-.134-.013-.2-.068-.483-.23-.951-.467-1.383-1.051-1.831-2.921-2.987-4.961-3.014-1.545-.038-3.012 1.04-3.96 1.04zm5.137 4.227c.78 1.012 1.312 2.441 1.169 3.845-1.13-.039-2.507-.753-3.325-1.701-.728-.845-1.364-2.194-1.195-3.506 1.273.104 2.571.35 3.351 1.362zm-11.766.078c.78-1.012 2.078-1.258 3.351-1.362.169 1.312-.467 2.661-1.195 3.506-.818.948-2.195 1.662-3.325 1.701-.143-1.404.389-2.833 1.169-3.845z" fill="currentColor"/></svg>
                  Apple
                </a>
