          ...
          <div className="grid md:grid-cols-2 min-h-[600px]">
            ...
            <div className="p-16 md:p-20 flex flex-col justify-center max-w-[640px]">
              ...
              <div className="flex gap-3 flex-wrap mt-4">
                <span className="text-[11px] font-semibold tracking-[1.5px] uppercase px-6 py-2.5 border-2 border-[#8b7ab4] rounded-full text-[#2d1b4e]">Private Venue</span>
                <span className="text-[11px] font-semibold tracking-[1.5px] uppercase px-6 py-2.5 border-2 border-[#8b7ab4] rounded-full text-[#2d1b4e]">300 Guests</span>
                <span className="text-[11px] font-semibold tracking-[1.5px] uppercase px-6 py-2.5 border-2 border-[#8b7ab4] rounded-full text-[#2d1b4e]">Open Format</span>
              </div>
            </div>
          </div>
        </section>
