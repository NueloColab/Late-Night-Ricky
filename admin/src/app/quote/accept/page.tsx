    ...
    return (
      <div className="min-h-screen bg-[#0d1f3d] flex items-center justify-center px-4">
        <div className="bg-white rounded-lg shadow-sm max-w-lg w-full p-10 text-center">
          <p className="text-2xl font-light tracking-[6px] text-[#0d1f3d] mb-6">LATE NIGHT RICKY</p>
    ...
    <div className="min-h-screen bg-[#0d1f3d] py-8 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm overflow-hidden mb-6">
          <div className="border-b-2 border-[#0d1f3d] p-6 sm:p-8 text-center">
            <div className="w-20 h-20 bg-[#0d1f3d] rounded-full flex items-center justify-center mx-auto mb-6">
              <span className="text-white text-4xl">✓</span>
            </div>
            <h1 className="text-2xl font-light text-[#0d1f3d] mb-3">
          ...
          <div className="p-6 sm:p-8 space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                ...
                <p className="font-semibold text-[#0d1f3d]">{quoteNumber || '#' + quoteId}</p>
              </div>
              {projectTitle && (
                <div>
            ...
            {items.length > 0 && (
              <div>
                ...
                <div className="flex justify-between items-center mt-3 pt-3 border-t-2 border-[#0d1f3d]">
                  ...
                  <span className="text-lg font-bold text-[#0d1f3d]">{formatCurrency(total)}</span>
                </div>
              </div>
            )}
            ...
            {Array.isArray(paymentSchedule) && paymentSchedule.length > 1 && (
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-5">
                <p className="text-xs uppercase tracking-widest font-medium text-[#0d1f3d] mb-3">
            ...
            {paymentTermsLabel && (!paymentSchedule || paymentSchedule.length <= 1) && (
              <div className="bg-[#f0f4f8] border border-[#d0dce6] rounded-lg p-4">
                <p className="text-sm text-gray-600">
                  <span className="text-xs uppercase tracking-widest text-[#0d1f3d] font-semibold">Payment Terms:</span>{' '}
                  {paymentTermsLabel}
                </p>
              </div>
            )}
        ...
        <div className="text-center mb-8">
          <p className="text-sm text-[#C5E5F8]">
