          ...
          <div className="p-10 md:p-16 max-w-[600px] mx-auto flex flex-col justify-center">
            ...
            <div className="flex gap-0 mb-10">
              <button
                ...
                className={`flex-1 py-3.5 px-7 border-2 border-[#111] text-xs font-semibold uppercase tracking-[1.5px] transition ${
                  activeTab === 'booking' ? 'bg-[#3a3a3a] text-white' : 'bg-white text-[#111] hover:bg-[#8a8a8a]'
                }`}
              >
                Booking
              </button>
              <button
                ...
                className={`flex-1 py-3.5 px-7 border-2 border-[#111] text-xs font-semibold uppercase tracking-[1.5px] transition ${
                  activeTab === 'private' ? 'bg-[#3a3a3a] text-white' : 'bg-white text-[#111] hover:bg-[#8a8a8a]'
                }`}
              >
                Private Message
              </button>
            ...
            {submitted ? (
              <div className="text-center py-10">
                ...
                <p className="text-sm text-[#b0b0b0]">We&apos;ll be in touch soon.</p>
                <button
                  onClick={() => setSubmitted(false)}
                  className="mt-6 px-6 py-2 border-2 border-[#111] rounded-full text-xs font-semibold uppercase tracking-[1px] hover:bg-[#3a3a3a] hover:text-white transition"
                >
                  Send another
                </button>
              </div>
              ...
              <div className="text-center py-10">
                ...
                <p className="text-sm text-[#b0b0b0]">Please reach out directly via email.</p>
                <a href={`mailto:${contactInfo.email}`} className="mt-4 inline-block px-6 py-2 border-2 border-[#111] rounded-full text-xs font-semibold uppercase tracking-[1px] hover:bg-[#3a3a3a] hover:text-white transition">
              ...
              <>
                ...
                >
                  <div className="mb-7">
                    ...
                    <input type="text" name="name" required className="w-full border-b-2 border-[#111] py-3 px-0 text-[15px] bg-transparent outline-none focus:border-[#7a7a7a] transition" />
                  </div>
                  <div className="mb-7">
                    <label className="block text-xs font-semibold uppercase tracking-[1.5px] mb-2">Email *</label>
                    <input type="email" name="email" required className="w-full border-b-2 border-[#111] py-3 px-0 text-[15px] bg-transparent outline-none focus:border-[#7a7a7a] transition" />
                  </div>
                  <div className="mb-7">
                    <label className="block text-xs font-semibold uppercase tracking-[1.5px] mb-2">Club Name *</label>
                    <input type="text" name="club" required className="w-full border-b-2 border-[#111] py-3 px-0 text-[15px] bg-transparent outline-none focus:border-[#7a7a7a] transition" />
                  </div>
                  <div className="mb-7">
                    <label className="block text-xs font-semibold uppercase tracking-[1.5px] mb-2">City *</label>
                    <input type="text" name="city" required className="w-full border-b-2 border-[#111] py-3 px-0 text-[15px] bg-transparent outline-none focus:border-[#7a7a7a] transition" />
                  </div>
                  <div className="mb-7">
                    <label className="block text-xs font-semibold uppercase tracking-[1.5px] mb-2">Fee *</label>
                    <input type="text" name="fee" required className="w-full border-b-2 border-[#111] py-3 px-0 text-[15px] bg-transparent outline-none focus:border-[#7a7a7a] transition" />
                  </div>
                  <div className="mb-7">
                    <label className="block text-xs font-semibold uppercase tracking-[1.5px] mb-2">Date *</label>
                    <input type="date" name="date" required className="w-full border-b-2 border-[#111] py-3 px-0 text-[15px] bg-transparent outline-none focus:border-[#7a7a7a] transition" />
                  </div>
                  {error && <p className="text-red-600 text-sm mb-4">{error}</p>}
                  <button
                    type="submit"
                    disabled={submitting}
                    className="w-full py-4 bg-[#3a3a3a] text-white text-sm font-semibold uppercase tracking-[2px] hover:bg-[#7a7a7a] transition disabled:opacity-50"
                  >
                ...
                >
                  ...
                  <div className="mb-7">
                    ...
                    <textarea name="message" required rows={4} className="w-full border-b-2 border-[#111] py-3 px-0 text-[15px] bg-transparent outline-none focus:border-[#7a7a7a] transition resize-y min-h-[80px]" />
                  </div>
                  {error && <p className="text-red-600 text-sm mb-4">{error}</p>}
                  <button
                    type="submit"
