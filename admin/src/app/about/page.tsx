      ...
      <div className="bg-white min-h-screen">
        <div className="pt-20 pb-0 px-6">
          <div className="max-w-[1200px] mx-auto">
            <Link
              href="/"
              className="inline-flex items-center gap-2 text-sm text-[#8b7ab4] hover:text-[#111] transition-colors"
            >
              <ArrowLeft size={14} />
              <span>Home</span>
            </Link>
        ...
        <div className="border-b-2 border-[#111] pt-4 pb-5 px-6">
          <div className="max-w-[1200px] mx-auto flex items-baseline gap-5 flex-wrap">
            ...
            <span className="font-['Rockybilly',cursive] text-[clamp(24px,3vw,40px)] text-[#8b7ab4] -rotate-1 inline-block opacity-85 whitespace-nowrap">Late Night Ricky</span>
          </div>
        </div>
        ...
        {/* Production Credits */}
        <section className="bg-[#0f0518] py-20 px-6">
          <div className="max-w-[1200px] mx-auto">
            <p className="text-xs text-[#8b7ab4] tracking-[3px] uppercase font-semibold mb-8 text-center">Production Credits</p>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
              {[
                ...
                <div key={name} className="text-[clamp(14px,1.8vw,20px)] font-black uppercase tracking-[-0.5px] text-white text-center py-3 px-2 hover:text-[#a890c0] transition cursor-default">
                  {name}
                </div>
              ))}
            </div>
