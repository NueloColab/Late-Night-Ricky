          ...
          <div className="grid md:grid-cols-2 min-h-[600px]">
            ...
            <div className="p-16 md:p-20 flex flex-col justify-center max-w-[640px]">
              ...
              <div className="flex gap-3 flex-wrap mt-4">
                <span className="text-[11px] font-semibold tracking-[1.5px] uppercase px-6 py-2.5 border-2 border-[#A8D5F0] rounded-full text-[#152a47]">Main Stage</span>
                <span className="text-[11px] font-semibold tracking-[1.5px] uppercase px-6 py-2.5 border-2 border-[#A8D5F0] rounded-full text-[#152a47]">1,500+</span>
                <span className="text-[11px] font-semibold tracking-[1.5px] uppercase px-6 py-2.5 border-2 border-[#A8D5F0] rounded-full text-[#152a47]">Hip-Hop / R&B</span>
              </div>
            </div>
          </div>
        </section>
