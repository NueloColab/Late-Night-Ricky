...
export async function POST() {
  ...
  try {
    ...
    const sections = [
      { page: 'home', section: 'hero', order: 0, content: { title: 'Late Night Ricky', subtitle: 'International DJ & Grammy Winning Producer', image: '/assets/ricky-hero-v2.jpg', logo: '/assets/ricky-logo.png', overlay: true }, isActive: true },
