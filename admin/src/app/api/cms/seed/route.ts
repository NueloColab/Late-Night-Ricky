...
export async function POST() {
  ...
  try {
    ...
    const sections = [
      { page: 'home', section: 'hero', order: 0, content: { title: 'Late Night Ricky', subtitle: 'International DJ & Grammy Winning Producer', image: '/assets/ricky-hero-v2.jpg', logo: '/assets/ricky-logo.png' }, isActive: true },
      ...
      { page: 'home', section: 'reach', order: 2, content: { headline: 'International DJ & Grammy Winning Producer. From London to New York / LA to Las Vegas / Miami to Ibiza and beyond.', subtext: '150+ shows worldwide. Grammy recognition for work with Chris Brown. Platinum-certified. Previously DJ Fricktion.' }, isActive: true },
      ...
      { page: 'home', section: 'radio', order: 5, content: { headline: 'As Heard On', description: 'Preview snippets of the latest releases. Click play to hear 30-second previews, then stream or download the full tracks on Spotify, Apple Music and YouTube.', spotifyUrl: 'https://open.spotify.com/artist/3lOtUgicoyDn2qKe5zc3dl', appleMusicUrl: 'https://music.apple.com/gb/artist/late-night-ricky/1759491226', youtubeUrl: 'https://www.youtube.com/@LateNightRicky' }, isActive: true },
      ...
      { page: 'home', section: 'contact', order: 8, content: { bookingEmail: 'samir@wearemediahive.com', instagram: '@latenightricky' }, isActive: true },
