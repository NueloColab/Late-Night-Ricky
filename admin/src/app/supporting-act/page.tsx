        ...
        <div className="max-w-[900px] mx-auto px-8 py-20 text-center">
          ...
          <div className="flex flex-col gap-1">
            {artists.map((name: string) => (
              <div key={name} className="text-[clamp(36px,7vw,80px)] font-black uppercase tracking-[-2px] leading-none text-[#111] hover:text-[#7a7a7a] transition cursor-default">
                {name}
              </div>
            ))}
          </div>
          <div className="w-[60px] h-0.5 bg-[#3a3a3a] mx-auto my-8 opacity-15" />
