    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-3">
          ...
          <p className="text-xs uppercase tracking-widest text-[#5B7A8E]">Inbox</p>
        </div>
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-[#5B7A8E] mt-4 font-semibold uppercase tracking-[0.5px]">Manage booking requests and messages</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        {[
          ...
          { label: 'Archived', value: stats.archived, icon: Archive, color: '#A3B5C4' },
        ].map((stat) => (
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-14 pr-4 py-3 bg-white border border-[#E3E8ED] text-[#111] placeholder-[#A3B5C4] text-sm focus:outline-none focus:border-[#1B3A4C] transition-colors"
              />
            </div>
          </div>
          <div>
              ...
              <tbody className="divide-y divide-[#E3E8ED]">
                {filteredEnquiries.map((e) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span className="text-sm text-[#5B7A8E] max-w-xs truncate block">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-end gap-2" onClick={(ev) => ev.stopPropagation()}>
                        ...
                        <button
                          ...
                          className="p-2 hover:bg-red-50 transition-colors text-[#A3B5C4] hover:text-red-500"
                        >
                          <Trash2 size={14} />
                        </button>
                      </div>
            ...
            <div className="bg-white border border-[#E3E8ED] max-w-md w-full p-6">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-[#5B7A8E]">This action cannot be undone. The enquiry will be permanently deleted.</p>
                </div>
              </div>
            ...
            >
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {selectedEnquiry.clubName && (
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        <Building2 className="w-4 h-4 text-[#A3B5C4]" />
                  ...
                  {selectedEnquiry.city && (
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        <MapPin className="w-4 h-4 text-[#A3B5C4]" />
                  ...
                  {selectedEnquiry.fee && (
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        <DollarSign className="w-4 h-4 text-[#A3B5C4]" />
                  ...
                  {selectedEnquiry.eventDate && (
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        <Calendar className="w-4 h-4 text-[#A3B5C4]" />
                ...
                <div className="pt-4 border-t border-[#E3E8ED]">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 bg-white border border-[#E3E8ED] text-sm text-[#111] placeholder-[#A3B5C4] focus:outline-none focus:border-[#1B3A4C] resize-none mb-3"
                  />
                  <button
                    onClick={handleSendReply}
                    disabled={!replyText.trim() || sendingReply}
                    className="inline-flex items-center gap-2 px-6 py-3 bg-[#1B3A4C] text-white text-xs uppercase tracking-wider hover:bg-[#0f1923] transition-colors disabled:opacity-50"
                  >
                    <Send size={14} />
              ...
              <div className="sticky bottom-0 bg-white border-t border-[#E3E8ED] p-6 space-y-4">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button
                      ...
                      className="px-4 py-2.5 bg-[#1B3A4C] text-white text-xs uppercase tracking-wider hover:bg-[#0f1923] transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
                    >
                      <FileText size={14} />
                    ...
                    <button
                      ...
                      className="px-4 py-2.5 bg-[#0f1923] text-white text-xs uppercase tracking-wider hover:bg-[#1B3A4C] transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
                    >
                      <Receipt size={14} />
                ...
                <button
                  ...
                  className="w-full text-xs uppercase tracking-wider text-[#A3B5C4] hover:text-red-600 transition-colors flex items-center justify-center gap-2 py-2"
                >
                  <Trash2 size={12} />
