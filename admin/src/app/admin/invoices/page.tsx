                  ...
                  return (
                    <tr key={inv.id} className="hover:bg-[#F8FAFB] transition-colors">
                      ...
                      <td className="px-4 py-3 text-[#5B7A8E]">
                        {inv.clientName || '—'}
                        {inv.clientCompany && (
                          <div className="text-xs text-[#A3B5C4]">{inv.clientCompany}</div>
                        )}
                      </td>
                      <td className="px-4 py-3 text-[#5B7A8E]">{inv.projectTitle || proj?.title || '—'}</td>
          ...
          <div className="space-y-4">
            ...
            {(selectedInvoice.clientName || selectedInvoice.projectTitle) && (
              <div className="bg-[#F8FAFB] p-4 rounded-lg border border-[#E3E8ED] space-y-1">
                ...
                {selectedInvoice.clientCompany && (
                  <div className="text-xs text-[#5B7A8E]">{selectedInvoice.clientCompany}</div>
                )}
                {selectedInvoice.clientEmail && (
                  <div className="text-xs text-[#6B8FAB]">{selectedInvoice.clientEmail}</div>
                )}
                {selectedInvoice.projectTitle && (
                  <div className="text-xs text-[#5B7A8E] pt-1 border-t border-[#E3E8ED] mt-1">{selectedInvoice.projectTitle}</div>
                )}
              </div>
            )}
            ...
            {selectedInvoice.notes && (
              <div className="bg-[#F8FAFB] p-4 rounded-lg border border-[#E3E8ED]">
                ...
                <p className="text-sm text-[#5B7A8E] whitespace-pre-wrap">{selectedInvoice.notes}</p>
              </div>
            )}
