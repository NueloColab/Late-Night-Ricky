    ...
    <div className="max-w-7xl mx-auto relative">
      ...
      <div className="flex items-center justify-between mb-12">
        <div>
          ...
          <p className="text-sm text-[#a0a0a0] mt-4 font-semibold uppercase tracking-[0.5px]">Edit sections and show cards</p>
        </div>
        <a
          href="/"
          target="_blank"
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-64 flex-shrink-0">
          <div className="bg-white border border-[#A8D5F0]/30 overflow-hidden">
            <div className="px-5 py-4 border-b border-[#A8D5F0]/30">
              <p className="text-xs text-[#A8D5F0] tracking-[3px] uppercase font-semibold">Sections</p>
            </div>
            <div className="divide-y divide-[#A8D5F0]/20">
          ...
          <div className="mt-4 bg-white border border-[#A8D5F0]/30 overflow-hidden">
            <button
            ...
            >
              ...
              <span className="text-xs text-[#A8D5F0]">{showCards.length}</span>
            </button>
          </div>
        </div>
        ...
        <div className="flex-1 min-w-0">
          {loading || cardsLoading ? (
            ...
            <p className="text-[#A8D5F0] text-sm">Select a section to edit.</p>
          )}
        </div>
      </div>
  ...
  if (!section) {
    return (
      <div className="bg-white border border-[#A8D5F0]/30 p-8">
        <p className="text-[#A8D5F0] text-sm">Hero section not found in database.</p>
      </div>
    );
  }
  const content = parseContent(section.content);
  return (
    <div className="bg-white border border-[#A8D5F0]/30 p-6 space-y-6">
      <div>
        <p className="text-xs text-[#A8D5F0] tracking-[3px] uppercase font-semibold mb-2">Hero</p>
        <p className="text-sm text-[#a0a0a0] font-semibold uppercase tracking-[0.5px]">Edit the hero headline and background image</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div>
          <label className="block text-xs font-semibold text-[#A8D5F0] uppercase tracking-[3px] mb-2">Subtitle</label>
          <input
            type="text"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="block text-xs font-semibold text-[#A8D5F0] uppercase tracking-[3px] mb-2">Background Image</label>
            <div className="relative w-full aspect-video bg-[#0d1f3d] rounded-xl overflow-hidden mb-2 border border-[#A8D5F0]/30">
              {content.image ? (
            ...
            <button
              ...
              className="px-4 py-2 border-2 border-[#111] rounded-full text-[11px] font-semibold uppercase tracking-[1px] text-[#111] hover:bg-[#0d1f3d] hover:text-white transition"
            >
              Replace Image
            </button>
          </div>
          <div>
            <label className="block text-xs font-semibold text-[#A8D5F0] uppercase tracking-[3px] mb-2">Logo</label>
            <div className="relative w-full aspect-video bg-[#0d1f3d] rounded-xl overflow-hidden mb-2 border border-[#A8D5F0]/30">
              {content.logo ? (
      ...
      <div className="flex items-center gap-6 py-2">
        <label className="inline-flex items-center gap-2 cursor-pointer">
          <input
            ...
            className="w-4 h-4 accent-[#152a47]"
          />
          <span className="text-sm font-semibold text-[#152a47]">Steel blue overlay</span>
        </label>
        <label className="inline-flex items-center gap-2 cursor-pointer">
          <input
            type="checkbox"
            ...
            className="w-4 h-4 accent-[#152a47]"
          />
          <span className="text-sm font-semibold text-[#152a47]">Black & white filter</span>
        </label>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
        <div>
          <label className="block text-xs font-semibold text-[#A8D5F0] uppercase tracking-[3px] mb-2">Zoom (Background Size)</label>
          <select
        ...
        <div>
          <label className="block text-xs font-semibold text-[#A8D5F0] uppercase tracking-[3px] mb-2">Position (Focus Point)</label>
          <select
        ...
        <div>
          <label className="block text-xs font-semibold text-[#A8D5F0] uppercase tracking-[3px] mb-2">Background Color (for gaps)</label>
          <div className="flex items-center gap-2">
            <input
              type="color"
              value={content.backgroundColor || '#c8cdd2'}
              onChange={(e) => onChange('backgroundColor', e.target.value)}
              className="w-10 h-10 rounded-lg border border-[#A8D5F0]/30 cursor-pointer"
            />
            <input
              type="text"
              value={content.backgroundColor || '#c8cdd2'}
          ...
          <p className="text-xs text-[#A8D5F0] mt-1">Pick a color that matches the photo background for seamless edges</p>
        </div>
      </div>
...
function VideoEditor({
  ...
  if (!section) {
    return (
      <div className="bg-white border border-[#A8D5F0]/30 p-8">
        <p className="text-[#A8D5F0] text-sm">Video section not found in database.</p>
      </div>
    );
  }
  const content = parseContent(section.content);
  return (
    <div className="bg-white border border-[#A8D5F0]/30 p-6 space-y-6">
      <div>
        <p className="text-xs text-[#A8D5F0] tracking-[3px] uppercase font-semibold mb-2">Video</p>
        <p className="text-sm text-[#a0a0a0] font-semibold uppercase tracking-[0.5px]">Edit the video poster and source URL</p>
      </div>

      <div className="space-y-4">
        <div>
          <label className="block text-xs font-semibold text-[#A8D5F0] uppercase tracking-[3px] mb-2">Video Source URL</label>
          <input
            type="url"
            value={content.src || ''}
        ...
        <div>
          <label className="block text-xs font-semibold text-[#A8D5F0] uppercase tracking-[3px] mb-2">Poster Image</label>
          <div className="relative w-full aspect-video bg-[#0d1f3d] rounded-xl overflow-hidden mb-2 max-w-md border border-[#A8D5F0]/30">
            {content.poster ? (
...
function ReachEditor({
  ...
  if (!section) {
    return (
      <div className="bg-white border border-[#A8D5F0]/30 p-8">
        <p className="text-[#A8D5F0] text-sm">Reach section not found in database.</p>
      </div>
    );
  }
  const content = parseContent(section.content);
  return (
    <div className="bg-white border border-[#A8D5F0]/30 p-6 space-y-6">
      <div>
        <p className="text-xs text-[#A8D5F0] tracking-[3px] uppercase font-semibold mb-2">Reach</p>
        <p className="text-sm text-[#a0a0a0] font-semibold uppercase tracking-[0.5px]">Edit the reach headline and subtext</p>
      </div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="w-full px-4 py-2.5 bg-white border border-[#A8D5F0]/30 rounded-lg text-sm text-[#152a47] focus:outline-none focus:border-[#152a47] resize-y"
          />
        </div>
        <div>
          <label className="block text-xs font-semibold text-[#A8D5F0] uppercase tracking-[3px] mb-2">Subtext</label>
          <textarea
        ...
        <div>
          <label className="block text-xs font-semibold text-[#A8D5F0] uppercase tracking-[3px] mb-2">Grammy Badge</label>
          <div className="flex items-center gap-2">
            <input
              type="text"
  ...
  return (
    <div className="bg-white border border-[#A8D5F0]/30 p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <p className="text-xs text-[#A8D5F0] tracking-[3px] uppercase font-semibold mb-1">Partners</p>
          <p className="text-sm text-[#a0a0a0] font-semibold uppercase tracking-[0.5px]">Edit partner logos — {logos.length} total</p>
        </div>
        <button
          onClick={onAdd}
          className="px-4 py-2 border-2 border-[#111] rounded-full text-[11px] font-semibold uppercase tracking-[1px] text-[#111] hover:bg-[#0d1f3d] hover:text-white transition"
      ...
      {loading ? (
        ...
        <p className="text-[#A8D5F0] text-sm">No partner logos yet.</p>
      ) : (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {logos.map((logo, idx) => (
            <div key={logo.id} className="border border-[#A8D5F0]/30 p-4 space-y-3 bg-white">
              <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-1 ml-auto">
                  <button
                    ...
                    disabled={idx === 0}
                    className="p-1.5 text-[#A8D5F0] hover:text-[#152a47] hover:bg-[#0d1f3d] rounded-lg transition-colors disabled:opacity-30"
                  >
              ...
              <div className="relative w-full aspect-[3/2] bg-[#0d1f3d] rounded-xl overflow-hidden border border-[#A8D5F0]/30">
                {logo.imagePath ? (
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 px-3 py-1.5 border-2 border-[#111] rounded-full text-[11px] font-semibold uppercase tracking-[1px] text-[#111] hover:bg-[#0d1f3d] hover:text-white transition"
                >
                  Replace Image
                </button>
                <button
                  ...
                  className="px-3 py-1.5 border border-[#A8D5F0]/50 rounded-full text-[11px] font-semibold uppercase tracking-[1px] text-[#152a47] hover:border-[#111] hover:text-[#111] transition disabled:opacity-50"
                >
...
function RadioEditor({
  ...
  return (
    <div className="bg-white border border-[#A8D5F0]/30 p-6 space-y-6">
      {section && (
        <div className="space-y-4 pb-4 border-b border-[#A8D5F0]/20">
          <p className="text-xs text-[#A8D5F0] tracking-[3px] uppercase font-semibold mb-1">Radio Section</p>
          <p className="text-sm text-[#a0a0a0] mb-4 font-semibold uppercase tracking-[0.5px]">Edit the radio section content and image</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-semibold text-[#A8D5F0] uppercase tracking-[3px] mb-2">Portrait Image</label>
              <div className="relative w-full aspect-video bg-[#0d1f3d] rounded-xl overflow-hidden mb-2 border border-[#A8D5F0]/30">
                {content.image ? (
            ...
            <div className="space-y-3">
              <div>
                <label className="block text-xs font-semibold text-[#A8D5F0] uppercase tracking-[3px] mb-2">Label</label>
                <input
                  type="text"
                  value={content.label || ''}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            <div>
              <label className="block text-xs font-semibold text-[#A8D5F0] uppercase tracking-[3px] mb-2">Spotify URL</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-xs font-semibold text-[#A8D5F0] uppercase tracking-[3px] mb-2">Apple Music URL</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-xs font-semibold text-[#A8D5F0] uppercase tracking-[3px] mb-2">YouTube URL</label>
              <input
                type="text"
      ...
      <div className="flex items-center justify-between">
        <div>
          <p className="text-xs text-[#A8D5F0] tracking-[3px] uppercase font-semibold mb-1">Tracks</p>
          <p className="text-sm text-[#a0a0a0] font-semibold uppercase tracking-[0.5px]">Edit audio tracks — {tracks.length} total</p>
        </div>
        <button
          onClick={onAdd}
          className="px-4 py-2 border-2 border-[#111] rounded-full text-[11px] font-semibold uppercase tracking-[1px] text-[#111] hover:bg-[#0d1f3d] hover:text-white transition"
      ...
      {loading ? (
        ...
        <p className="text-[#A8D5F0] text-sm">No tracks yet.</p>
      ) : (
        <div className="space-y-3">
          {tracks.map((track, idx) => (
            <div key={track.id} className="border border-[#A8D5F0]/30 rounded-xl p-4 bg-white">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-3 items-end">
                ...
                <div>
                  <label className="block text-xs font-semibold text-[#A8D5F0] uppercase tracking-[3px] mb-2">Duration</label>
                  <input
                    type="text"
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="p-2 border-2 border-[#111] rounded-full text-[#111] hover:bg-[#0d1f3d] hover:text-white transition disabled:opacity-30"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 px-3 py-2 border border-[#A8D5F0]/50 rounded-full text-[11px] font-semibold uppercase tracking-[1px] text-[#152a47] hover:border-[#111] hover:text-[#111] transition disabled:opacity-50"
                  >
              ...
              <div className="mt-2">
                <label className="block text-xs font-semibold text-[#A8D5F0] uppercase tracking-[3px] mb-2">Audio File</label>
                <div className="flex items-center gap-2">
                  <input
                    type="text"
                  ...
                  <label className={`inline-flex items-center gap-1.5 px-3 py-2 rounded-lg text-xs font-semibold cursor-pointer transition-colors ${
                    savingTrack === track.id ? 'bg-[#A8D5F0] text-white' : 'bg-[#152a47] text-white hover:bg-[#2a4f66]'
                  }`}>
...
function ClientsEditor({
  ...
  return (
    <div className="bg-white border border-[#A8D5F0]/30 p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <p className="text-xs text-[#A8D5F0] tracking-[3px] uppercase font-semibold mb-1">Clients</p>
          <p className="text-sm text-[#a0a0a0] font-semibold uppercase tracking-[0.5px]">Edit client names — {clients.length} total</p>
        </div>
        <button
          onClick={onAdd}
          className="px-4 py-2 border-2 border-[#111] rounded-full text-[11px] font-semibold uppercase tracking-[1px] text-[#111] hover:bg-[#0d1f3d] hover:text-white transition"
      ...
      {loading ? (
        ...
        <p className="text-[#A8D5F0] text-sm">No clients yet.</p>
      ) : (
        <div className="space-y-2">
          {clients.map((client, idx) => (
            <div key={client.id} className="flex items-center gap-3 border border-[#A8D5F0]/30 px-4 py-3 bg-white">
              <span className="text-xs font-semibold text-[#A8D5F0] uppercase tracking-[2px] w-8">{idx + 1}</span>
              <input
                type="text"
                value={client.name}
...
function ShareEditor({
  ...
  if (!section) {
    return (
      <div className="bg-white border border-[#A8D5F0]/30 p-8">
        <p className="text-[#A8D5F0] text-sm">Share Music section not found in database.</p>
      </div>
    );
  }
  const content = parseContent(section.content);
  return (
    <div className="bg-white border border-[#A8D5F0]/30 p-6 space-y-6">
      <div>
        <p className="text-xs text-[#A8D5F0] tracking-[3px] uppercase font-semibold mb-2">Share Music</p>
        <p className="text-sm text-[#a0a0a0] font-semibold uppercase tracking-[0.5px]">Edit the share music headline and description</p>
      </div>
...
function ContactEditor({
  ...
  if (!section) {
    return (
      <div className="bg-white border border-[#A8D5F0]/30 p-8">
        <p className="text-[#A8D5F0] text-sm">Contact section not found in database.</p>
      </div>
    );
  }
  const content = parseContent(section.content);
  return (
    <div className="bg-white border border-[#A8D5F0]/30 p-6 space-y-6">
      <div>
        <p className="text-xs text-[#A8D5F0] tracking-[3px] uppercase font-semibold mb-2">Reach Out</p>
        <p className="text-sm text-[#a0a0a0] font-semibold uppercase tracking-[0.5px]">Edit contact details</p>
      </div>

      <div className="space-y-4">
        <div>
          <label className="block text-xs font-semibold text-[#A8D5F0] uppercase tracking-[3px] mb-2">Booking Email</label>
          <input
            type="email"
  ...
  return (
    <div className="space-y-4">
      <div className="bg-white border border-[#A8D5F0]/30 p-6">
        <p className="text-xs text-[#A8D5F0] tracking-[3px] uppercase font-semibold mb-1">Show Cards</p>
        <p className="text-sm text-[#a0a0a0] font-semibold uppercase tracking-[0.5px] mb-6">Reorder and edit each show card</p>

        <div className="space-y-4">
          {cards.map((card, idx) => (
            <div key={card.id} className="border border-[#A8D5F0]/30 p-4 bg-white">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-semibold text-[#A8D5F0] uppercase tracking-[3px] mb-2">Image</label>
                  <div className="relative w-full aspect-video bg-[#0d1f3d] rounded-xl overflow-hidden mb-2 border border-[#A8D5F0]/30">
                    {card.imagePath ? (
...
function CarouselEditor({
  ...
  return (
    <div className="bg-white border border-[#A8D5F0]/30 p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <p className="text-xs text-[#A8D5F0] tracking-[3px] uppercase font-semibold mb-1">Carousel</p>
          <p className="text-sm text-[#a0a0a0] font-semibold uppercase tracking-[0.5px]">Edit carousel images — {images.length} total</p>
        </div>
        <button
          onClick={onAdd}
          className="px-4 py-2 border-2 border-[#111] rounded-full text-[11px] font-semibold uppercase tracking-[1px] text-[#111] hover:bg-[#0d1f3d] hover:text-white transition"
      ...
      {loading ? (
        ...
        <p className="text-[#A8D5F0] text-sm">No images yet.</p>
      ) : (
        <div className="space-y-3">
          {images.map((img, idx) => (
            <div key={img.id} className="border border-[#A8D5F0]/30 rounded-xl p-4 bg-white">
              <div className="flex items-center gap-3 mb-3">
                <span className="text-xs font-semibold text-[#A8D5F0] uppercase tracking-[2px]">#{idx + 1}</span>
                <div className="flex items-center gap-1 ml-auto">
                  <button
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 items-end">
                <div className="md:col-span-2">
                  <label className="block text-xs font-semibold text-[#A8D5F0] uppercase tracking-[3px] mb-2">Alt Text</label>
                  <input
                    type="text"
                    value={img.alt}
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-3 py-2 border-2 border-[#111] rounded-full text-[11px] font-semibold uppercase tracking-[1px] text-[#111] hover:bg-[#0d1f3d] hover:text-white transition"
                  >
                    Replace Image
                  </button>
                  <button
              ...
              {img.imagePath && (
                <div className="mt-2 aspect-video bg-[#0d1f3d] rounded-lg overflow-hidden">
...
function ReachOutEditor({
  ...
  if (!section) return <p className="text-[#A8D5F0] text-sm">Section not found.</p>;
  const content = parseContent(section.content);
  return (
    <div className="bg-white border border-[#A8D5F0]/30 p-6 space-y-6">
      <p className="text-xs text-[#A8D5F0] tracking-[3px] uppercase font-semibold mb-1">Reach Out</p>
      <p className="text-sm text-[#a0a0a0] mb-6 font-semibold uppercase tracking-[0.5px]">Edit the reach out section.</p>
      <div className="space-y-4">
        <div>
          <label className="block text-xs font-semibold text-[#A8D5F0] uppercase tracking-[3px] mb-2">Headline</label>
          <input
        ...
        <div>
          <label className="block text-xs font-semibold text-[#A8D5F0] uppercase tracking-[3px] mb-2">Signature</label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-xs font-semibold text-[#A8D5F0] uppercase tracking-[3px] mb-2">CTA Text</label>
          <input
            type="text"
            value={content.cta || ''}
        ...
        <button
          onClick={onSave}
          disabled={saving}
          className="px-6 py-2.5 border-2 border-[#111] rounded-full text-[13px] font-semibold uppercase tracking-[1.5px] text-[#111] hover:bg-[#0d1f3d] hover:text-white transition disabled:opacity-50"
        >
