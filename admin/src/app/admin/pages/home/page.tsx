      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <div className="relative w-full aspect-video bg-[#E3E8ED] rounded-xl overflow-hidden mb-2 border border-[#6B8FAB]/30">
              {content.image ? (
            ...
            <button
              ...
              className="px-4 py-2 border-2 border-[#111] rounded-full text-[11px] font-semibold uppercase tracking-[1px] text-[#111] hover:bg-[#E3E8ED] hover:text-white transition"
            >
              Replace Image
            </button>
          </div>
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="w-10 h-10 rounded-lg border border-[#6B8FAB]/30 cursor-pointer"
            />
            <input
              type="text"
              value={content.backgroundColor || '#c8cdd2'}
    ...
    <div className="bg-white border border-[#6B8FAB]/30 p-6 space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="relative w-full aspect-video bg-[#E3E8ED] rounded-xl overflow-hidden mb-2 max-w-md border border-[#6B8FAB]/30">
            {content.poster ? (
    ...
    <div className="bg-white border border-[#6B8FAB]/30 p-6 space-y-6">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {logos.map((logo, idx) => (
            <div key={logo.id} className="border border-[#6B8FAB]/30 p-4 space-y-3 bg-white">
              <div className="flex items-center gap-2">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 px-3 py-1.5 border-2 border-[#111] rounded-full text-[11px] font-semibold uppercase tracking-[1px] text-[#111] hover:bg-[#E3E8ED] hover:text-white transition"
                >
                  Replace Image
                </button>
                <button
                  ...
                  className="px-3 py-1.5 border border-[#6B8FAB]/50 rounded-full text-[11px] font-semibold uppercase tracking-[1px] text-[#1B3A4C] hover:border-[#111] hover:text-[#111] transition disabled:opacity-50"
                >
...
function RadioEditor({
  ...
  return (
    <div className="bg-white border border-[#6B8FAB]/30 p-6 space-y-6">
      {section && (
        <div className="space-y-4 pb-4 border-b border-[#6B8FAB]/20">
      ...
      {loading ? (
        ...
        <div className="space-y-3">
          {tracks.map((track, idx) => (
            <div key={track.id} className="border border-[#6B8FAB]/30 rounded-xl p-4 bg-white">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-3 items-end">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="p-2 border-2 border-[#111] rounded-full text-[#111] hover:bg-[#E3E8ED] hover:text-white transition disabled:opacity-30"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 px-3 py-2 border border-[#6B8FAB]/50 rounded-full text-[11px] font-semibold uppercase tracking-[1px] text-[#1B3A4C] hover:border-[#111] hover:text-[#111] transition disabled:opacity-50"
                  >
      ...
      {loading ? (
        ...
        <div className="space-y-2">
          {clients.map((client, idx) => (
            <div key={client.id} className="flex items-center gap-3 border border-[#6B8FAB]/30 px-4 py-3 bg-white">
  ...
  return (
    <div className="space-y-4">
      <div className="bg-white border border-[#6B8FAB]/30 p-6">
        ...
        <div className="space-y-4">
          {cards.map((card, idx) => (
            <div key={card.id} className="border border-[#6B8FAB]/30 p-4 bg-white">
  ...
  return (
    <div className="bg-white border border-[#6B8FAB]/30 p-6 space-y-6">
      ...
      {loading ? (
        ...
        <div className="space-y-3">
          {images.map((img, idx) => (
            <div key={img.id} className="border border-[#6B8FAB]/30 rounded-xl p-4 bg-white">
              <div className="flex items-center gap-3 mb-3">
                <span className="text-xs font-semibold text-[#6B8FAB] uppercase tracking-[2px]">#{idx + 1}</span>
                <div className="flex items-center gap-1 ml-auto">
                  <button
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 items-end">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-3 py-2 border-2 border-[#111] rounded-full text-[11px] font-semibold uppercase tracking-[1px] text-[#111] hover:bg-[#E3E8ED] hover:text-white transition"
                  >
                    Replace Image
                  </button>
                  <button
    ...
    <div className="bg-white border border-[#6B8FAB]/30 p-6 space-y-6">
      ...
      <div className="space-y-4">
        ...
        <button
          onClick={onSave}
          disabled={saving}
          className="px-6 py-2.5 border-2 border-[#111] rounded-full text-[13px] font-semibold uppercase tracking-[1.5px] text-[#111] hover:bg-[#E3E8ED] hover:text-white transition disabled:opacity-50"
        >
