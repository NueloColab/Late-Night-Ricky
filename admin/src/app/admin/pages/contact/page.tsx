    ...
    <div className="max-w-7xl mx-auto relative">
      ...
      <div className="flex items-center justify-between mb-12">
        <div>
          ...
          <p className="text-sm text-[#7a6a9e] mt-4 font-semibold uppercase tracking-[0.5px]">Edit email, Instagram, and form settings</p>
        </div>
        <a
          href="/contact"
          target="_blank"
        ...
        <div className="flex-1 min-w-0">
          {loading ? (
            ...
            <div className="bg-white border border-[#8b7ab4]/30 p-6">
              <p className="text-xs text-[#8b7ab4] tracking-[3px] uppercase font-semibold mb-1">Contact</p>
              <p className="text-sm text-[#7a6a9e] mb-6 font-semibold uppercase tracking-[0.5px]">The portrait image on the left side of the contact page</p>
              <div className="relative w-full max-w-md aspect-[3/4] bg-[#1a0a2e] rounded-xl overflow-hidden mb-4 border border-[#8b7ab4]/30">
                {imageValue ? (
            ...
            <div className="bg-white border border-[#8b7ab4]/30 p-6">
              <p className="text-xs text-[#8b7ab4] tracking-[3px] uppercase font-semibold mb-1">Contact</p>
              <p className="text-sm text-[#7a6a9e] mb-6 font-semibold uppercase tracking-[0.5px]">The contact email displayed on the site</p>
              <input
                type="email"
                value={emailValue}
                onChange={(e) => {
                ...
                className="w-full px-3 py-2 bg-white border border-[#8b7ab4]/30 rounded-lg text-sm text-[#2d1b4e] focus:outline-none focus:border-[#2d1b4e] mb-4"
              />
              <button
            ...
            <div className="bg-white border border-[#8b7ab4]/30 p-6">
              <p className="text-xs text-[#8b7ab4] tracking-[3px] uppercase font-semibold mb-1">Contact</p>
              <p className="text-sm text-[#7a6a9e] mb-6 font-semibold uppercase tracking-[0.5px]">The Instagram handle displayed on the site</p>
              <input
                type="text"
            ...
            <div className="bg-white border border-[#8b7ab4]/30 p-6">
              <p className="text-xs text-[#8b7ab4] tracking-[3px] uppercase font-semibold mb-1">Contact</p>
              <p className="text-sm text-[#7a6a9e] mb-6 font-semibold uppercase tracking-[0.5px]">Toggle the contact form on or off</p>

              <div className="flex items-center justify-between p-4 bg-[#1a0a2e] rounded-xl mb-6">
                <div>
                  <p className="text-sm font-semibold text-[#2d1b4e]">Form Enabled</p>
                  <p className="text-xs text-[#8b7ab4]">Visitors can submit the contact form</p>
                </div>
                <button
                  onClick={() => {
                  ...
                  className={`relative inline-flex h-7 w-12 items-center rounded-full transition-colors ${formEnabled ? 'bg-[#2d1b4e]' : 'bg-[#8b7ab4]'}`}
                >
                  <span
              ...
              <p className="text-xs text-[#8b7ab4]">The form fields are managed in the public site code.</p>
            </div>
          ) : null}
        </div>
      </div>
