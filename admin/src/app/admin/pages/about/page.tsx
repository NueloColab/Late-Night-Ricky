    ...
    <div className="max-w-5xl">
      <div className="mb-12">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-[#5B7A8E] mt-4 font-semibold uppercase tracking-[0.5px]">Edit portrait, bio, and headline</p>
          </div>
          <a
            href="/about"
            target="_blank"
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        <div className="lg:w-64 flex-shrink-0">
          ...
          {hasData && (
            <div className="mt-4 bg-white border border-[#A3B5C4]/30 rounded-xl p-4">
              ...
              <div className="space-y-1.5 text-xs">
                {[
                  ...
                  <div key={key} className="flex justify-between">
                    <span className="text-[#5B7A8E]">{label}</span>
                    <span className={content[key] ? 'text-[#2d6a2d] font-semibold' : 'text-[#A3B5C4]'}>
                      {content[key] ? 'Set' : '—'}
                    </span>
                  </div>
                ))}
            ...
            <div className="bg-white border border-[#A3B5C4]/30 rounded-xl p-6 md:p-8">
              ...
              <div className="relative w-full max-w-sm aspect-[3/4] bg-[#F8FAFB] rounded-xl border border-[#E3E8ED] overflow-hidden mb-4 flex items-center justify-center">
                {portraitPath ? (
                  ...
                  <svg className="w-12 h-12 text-[#A3B5C4]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 bg-white border border-[#A3B5C4]/30 rounded-lg text-[#1B3A4C] text-sm focus:outline-none focus:border-[#1B3A4C] transition-colors"
                  />
                </div>
                  ...
                  return (
                    <div key={key}>
                      ...
                      <textarea
                        ...
                        rows={4}
                        className="w-full px-4 py-2.5 bg-white border border-[#A3B5C4]/30 rounded-lg text-[#1B3A4C] text-sm focus:outline-none focus:border-[#1B3A4C] transition-colors resize-y"
                      />
                    </div>
                  );
                })}
