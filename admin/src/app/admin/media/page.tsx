    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-6">
        <input
          ...
          className="flex-1 px-4 py-3 bg-white rounded-xl border border-[#C5E5F8]/30 text-sm focus:outline-none focus:border-[#1B3A4C] text-white"
        />
        <select
          value={filter}
          onChange={(e) => setFilter(e.target.value)}
          className="px-4 py-3 bg-white rounded-xl border border-[#C5E5F8]/30 text-sm focus:outline-none focus:border-[#1B3A4C] text-white"
        >
          {types.map((t) => (
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
          {filtered.map((asset) => (
            <div
              key={asset.id}
              className="group bg-white rounded-2xl overflow-hidden border border-[#C5E5F8]/20 hover:border-[#1B3A4C] transition-shadow"
            >
