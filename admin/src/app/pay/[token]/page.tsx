    ...
    return (
      <div className="min-h-screen bg-[#3a3a3a] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm text-[#d0d0d0]">Loading invoice...</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-[#3a3a3a] flex items-center justify-center px-4">
        <div className="bg-white rounded-lg shadow-sm max-w-lg w-full p-10 text-center">
          ...
          <div className="w-20 h-20 bg-[#3a3a3a] rounded-full flex items-center justify-center mx-auto mb-8">
            <span className="text-white text-4xl">✓</span>
          </div>
          <h1 className="text-2xl font-light text-[#3a3a3a] mb-4">Thank You for Your Payment</h1>
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 mb-6 text-left">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-semibold text-[#3a3a3a]">{formatCurrency(parseFloat(amountPaid))}</span>
              </div>
              <div className="flex justify-between">
    ...
    return (
      <div className="min-h-screen bg-[#3a3a3a] flex items-center justify-center px-4">
        <div className="bg-white rounded-lg shadow-sm max-w-lg w-full p-10 text-center">
          ...
          <h1 className="text-2xl font-light text-[#3a3a3a] mb-4">Payment Already Confirmed</h1>
    ...
    <div className="min-h-screen bg-[#3a3a3a] py-8 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm overflow-hidden mb-6">
          <div className="border-b-2 border-[#3a3a3a] p-6 sm:p-8">
            <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
              ...
              <div className="text-left sm:text-right">
                ...
                <p className="text-3xl font-light text-[#3a3a3a]">{formatCurrency(invoice.total)}</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 sm:p-8 space-y-6">
            ...
            {invoice.lineItems?.length > 0 && (
              <div>
                  ...
                  {invoice.lineItems.map((s: any, i: number) => (
                    <div key={i} className={`flex justify-between items-center px-4 py-3 text-sm ${i % 2 === 1 ? 'bg-gray-50' : ''} ${i < invoice.lineItems.length - 1 ? 'border-b border-gray-100' : ''}`}>
                      <div>
                        ...
                        {s.serviceCategory && <span className="ml-2 text-xs uppercase text-[#d0d0d0]">{s.serviceCategory}</span>}
                      </div>
                ...
                <div className="flex justify-between items-center mt-3 pt-3 border-t-2 border-[#3a3a3a]">
                  ...
                  <span className="text-lg font-bold text-[#3a3a3a]">{formatCurrency(invoice.total)}</span>
                </div>
              </div>
            )}
            ...
            <div className="bg-[#f0f4f8] border border-[#d0dce6] rounded-lg p-5">
              <p className="text-xs uppercase tracking-widest text-[#3a3a3a] font-semibold mb-3">Bank Details for Payment</p>
        ...
        {!showForm ? (
          <div className="text-center">
            <button
              ...
              className="inline-block bg-[#3a3a3a] text-white px-10 py-4 text-sm font-semibold uppercase tracking-widest rounded hover:bg-[#7a7a7a] transition-colors"
            >
              Confirm Payment
            </button>
            <p className="text-xs text-[#d0d0d0] mt-3">Click above after you&apos;ve made your payment</p>
          </div>
        ) : (
          <div className="bg-white rounded-lg shadow-sm p-6 sm:p-8">
            <h2 className="text-lg font-light text-[#3a3a3a] mb-6">Confirm Your Payment</h2>
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <select
                  ...
                  className="w-full border border-gray-200 rounded px-4 py-3 text-sm focus:outline-none focus:border-[#3a3a3a] transition-colors bg-white"
                >
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full border border-gray-200 rounded px-4 py-3 text-sm focus:outline-none focus:border-[#3a3a3a] transition-colors"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-200 rounded px-4 py-3 text-sm file:mr-4 file:py-1 file:px-3 file:rounded file:border-0 file:text-xs file:font-semibold file:bg-gray-100 file:text-[#3a3a3a] hover:file:bg-gray-200"
                />
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full border border-gray-200 rounded px-4 py-3 text-sm focus:outline-none focus:border-[#3a3a3a] transition-colors resize-none"
                />
              </div>
              ...
              <div className="flex gap-3 pt-2">
                <button
                  type="submit"
                  disabled={submitting}
                  className="flex-1 bg-[#3a3a3a] text-white px-6 py-3 text-sm font-semibold uppercase tracking-widest rounded hover:bg-[#7a7a7a] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
